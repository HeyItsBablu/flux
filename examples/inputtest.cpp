        ...
        Column(
            {
                ...
                Row({Text("Toggle")
                     ...
                     Toggle("Enable feature")
                         ...
                         ->setOnToggleChanged(
                             [this](bool v) { toggleState.set(v); }),
                     Text(toggleState, [](bool v) { return v ? "On" : "Off"; })
                ...
                Row({Text("Slider")
                     ...
                     Slider(0.0, 100.0, 1.0)
                         ...
                         ->setOnValueChanged(
                             [this](double v) { sliderState.set(v); }),
                     Text(sliderState,
                          [](double v) { return std::to_string((int)v); })
                         ->setMinWidth(32)
                         ->setTextColor(Color::fromRGB(100, 100, 100))})
                    ->setSpacing(12)
                    ->setPadding(16),
                ...
                Row({Text("CheckBox")
                     ...
                     Text(checkState,
                          [](bool v) { return v ? "Checked" : "Unchecked"; })
                         ->setTextColor(Color::fromRGB(100, 100, 100))})
                    ->setSpacing(12)
                    ->setPadding(16),
                ...
                Row({Text("Radio")
                     ...
                     Text(radioState, [](const std::string &v) { return v; })
                         ->setTextColor(Color::fromRGB(100, 100, 100))})
                    ->setSpacing(12)
                    ->setPadding(16),
                ...
                // ── NumberInput ───────────────────────────────────────────
                Row({Text("NumberInput")
                         ->setFontWeight(FontWeight::Bold)
                         ->setMinWidth(120),
                     NumberInput(0.0, 999.0, 1.0)
                         ->setValue(numberState)
                         ->setOnValueChanged(
                             [this](double v) { numberState.set(v); })
                         ->setWidth(120),
                     Text(
                         numberState,
                         [](double v) { return "= " + std::to_string((int)v); })
