...
public:
  ...
  WidgetPtr build() override {
    ...
    auto ctxMenu = ContextMenu(ctxAnchor, {
      ContextMenuItem::Action("Copy",  [this]{ lastAction.set("ContextMenu: Copy");  }),
      ContextMenuItem::Action("Paste", [this]{ lastAction.set("ContextMenu: Paste"); }),
      ContextMenuItem::Separator(),
      ContextMenuItem::Action("Delete",[this]{ lastAction.set("ContextMenu: Delete");}),
