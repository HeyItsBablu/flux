// flux_canvas_macos.mm — STUBS ONLY
...
bool CanvasWidget::isInitialized() const  { return false; }
bool CanvasWidget::needsRepaint()  const  { return false; }
bool CanvasWidget::containsPoint(int, int) const { return false; }
...
void CanvasWidget::computeLayout(GraphicsContext&,
...
void CanvasWidget::onWindowResize(int, int) {}
...
void CanvasWidget::onMouseButtonDown(int, int, int) {}

void CanvasWidget::onMouseButtonUp(int, int, int) {}

void CanvasWidget::onMouseMove(int, int) {}

void CanvasWidget::onScrollWheel(float) {}

void CanvasWidget::onKeyDown(int) {}
