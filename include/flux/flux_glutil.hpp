...
// Column-major orthographic projection: maps [l,r] x [b,t] → NDC.
// out must be float[16].
...
// ============================================================================
// Viewport::buildMVP — defined here because it needs glutil::ortho,
// but Viewport is declared in flux_canvas_types.hpp which must stay GL-free.
// ============================================================================
