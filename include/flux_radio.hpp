...
public:
    ...
    std::shared_ptr<RadioGroupWidget> setOnSelectionChanged(std::function<void(const std::string&)> callback)
    {
...
inline RadioButtonWidgetPtr RadioButton(const std::string& value, const std::string& label = "")
{
...
inline RadioGroupWidgetPtr RadioGroupWithOptions(const std::initializer_list<RadioOption>& options)
{
...
inline RadioGroupWidgetPtr RadioGroupWithOptions(const std::initializer_list<std::string>& options)
{
    auto group = std::make_shared<RadioGroupWidget>();
